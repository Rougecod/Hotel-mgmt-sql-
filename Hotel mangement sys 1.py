...
my.image = simg
my.place(x=0,y=0)
Frame(sroot,height=516,width=5,bg='black').place(x=605,y=0)
#chilanka
Label(sroot,text="Hotel Management System ",font='Timesnewroman 28 ',bg='white',fg='black').place(x=650,y=10)
Label(sroot,text="Made by -",font='Timesnewroman 28 ',bg='white',fg='black').place(x=650,y=90)
Label(sroot,text="Mayur udupa",font='Timesnewroman 28 ',bg='white',fg='grey').place(x=650,y=180)
Label(sroot,text="Kshithij Shetty",font='Timesnewroman 28',bg='white',fg='grey').place(x=650,y=270)
Label(sroot,text="vidhwath Jain",font='Timesnewroman 28',bg='white',fg='grey').place(x=650,y=360)
...
def mainroot():
	...
	root.title("hotel_mangaement_system")
	#--------------seperator-------------------------------------------------------------------------------------------------------------------
	...
	#-----------------------------------------------------------------
		nl = Label(b_frame,text='hotel_mgmt_sys',fg='black',bg='gray91',font='msserif 8')
	...
	def staff():
		...
		Label(emp1inf,text="Mr. Vidhwath",bg='white',fg="Grey",font='msserif 10').place(x=60,y=37)
		...
		Label(emp1inf,text="Ms. Kanishya Rao",bg='white',fg="Grey",font='msserif 10').place(x=45,y=37)
		...
		Label(emp1inf,text="Ms. Palak (Head)",bg='white',fg="Grey",font='msserif 10').place(x=55,y=37)
